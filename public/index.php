...
$router->get('/', 'HomeController', 'index')
    ...
    ->get('/admin/services/process', 'AdminManagerController', 'serviceProcessSteps')
    ->post('/admin/services/process/list', 'AdminManagerController', 'fetchServiceProcessSteps')
    ->post('/admin/services/process', 'AdminManagerController', 'storeServiceProcessStep')
    ->post('/admin/services/process/reorder', 'AdminManagerController', 'reorderServiceProcessSteps')
    ->post('/admin/services/process/{id}/update', 'AdminManagerController', 'updateServiceProcessStep')
    ->post('/admin/services/process/{id}/delete', 'AdminManagerController', 'deleteServiceProcessStep')
    ->post('/admin/services/process/{id}/toggle', 'AdminManagerController', 'toggleServiceProcessStep')
    ->get('/admin/services/pricing', 'AdminManagerController', 'pricingPlans')
    ->post('/admin/services/pricing/list', 'AdminManagerController', 'fetchPricingPlans')
    ->post('/admin/services/pricing', 'AdminManagerController', 'storePricingPlan')
    ->post('/admin/services/pricing/reorder', 'AdminManagerController', 'reorderPricingPlans')
    ->post('/admin/services/pricing/{id}/update', 'AdminManagerController', 'updatePricingPlan')
    ->post('/admin/services/pricing/{id}/delete', 'AdminManagerController', 'deletePricingPlan')
    ->post('/admin/services/pricing/{id}/toggle', 'AdminManagerController', 'togglePricingPlan')
    ->post('/admin/services/pricing/{id}/highlight', 'AdminManagerController', 'highlightPricingPlan')
    ->get('/admin/services/faqs', 'AdminManagerController', 'faqs')
    ->post('/admin/services/faqs/list', 'AdminManagerController', 'fetchFaqs')
    ->post('/admin/services/faqs', 'AdminManagerController', 'storeFaq')
    ->post('/admin/services/faqs/reorder', 'AdminManagerController', 'reorderFaqs')
    ->post('/admin/services/faqs/{id}/update', 'AdminManagerController', 'updateFaq')
    ->post('/admin/services/faqs/{id}/delete', 'AdminManagerController', 'deleteFaq')
    ->post('/admin/services/faqs/{id}/toggle', 'AdminManagerController', 'toggleFaq')
